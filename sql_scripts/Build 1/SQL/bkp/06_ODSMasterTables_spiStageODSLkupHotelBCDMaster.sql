...
V5 - Ankur	   - on 04/19/2018 Modified the current view to exclude the orphan hotel records as per BCDETL-334.	 
 ...
 V03 - Ankur - 20200206 - Added column LanyonID as per DN-1651
 =============================================
...
BEGIN
	...
	-- **************************************************************
	-- This needs to be parameterized or pulled from the driver table	
	--SET @LastRunDate = GETDATE()-1
	-- **************************************************************


	DROP TABLE IF EXISTS dbo.#tmpHotelKeyDelta
	-- Delta based on changes in Bridge Table and BCDHotelMaster
	SELECT  a.HotelKey
	INTO	dbo.#tmpHotelKeyDelta
	...
	UNION
	-- Delta based on changes in Brand data (BCDHotelMaster.BrandCode)
	SELECT  a.HotelKey
	FROM    dbo.ODSLkupHotel a
			JOIN dbo.ODSLkupHotelBCDMaster b ON b.HotelKey = a.HotelKey
			JOIN dbo.BCDHotelMaster c ON c.BCDPropertyId = b.BCDPropertyID
	...
	UNION
	-- Delta based on changes in Brand data (ODSLkupHotel.HotelChainCode)
	SELECT  a.HotelKey
	FROM    dbo.ODSLkupHotel a
			JOIN dbo.ODSLkupHotelBCDMaster b ON b.HotelKey = a.HotelKey
			JOIN dbo.BCDHotelMaster c ON c.BCDPropertyId = b.BCDPropertyID
	...
	UNION
	-- Delta based on changes in City data (BCDHotelMaster.AirportCode)
	SELECT  a.HotelKey
	FROM    dbo.ODSLkupHotel a
			JOIN dbo.ODSLkupHotelBCDMaster b ON b.HotelKey = a.HotelKey
			JOIN dbo.BCDHotelMaster c ON c.BCDPropertyId = b.BCDPropertyID
	...
	UNION
	-- Delta based on changes in City data (ODSLkupHotel.HotelCityCode)
	SELECT  a.HotelKey
	FROM    dbo.ODSLkupHotel a
			JOIN dbo.ODSLkupHotelBCDMaster b ON b.HotelKey = a.HotelKey
			JOIN dbo.BCDHotelMaster c ON c.BCDPropertyId = b.BCDPropertyID
...
*/
    ...
    INTO   #tmp_HotelResults
	  ...
	  -- Start of V02
	  JOIN #tmpHotelKeyDelta t ON t.HotelKey = olh.HotelKey
      -- End of V02
