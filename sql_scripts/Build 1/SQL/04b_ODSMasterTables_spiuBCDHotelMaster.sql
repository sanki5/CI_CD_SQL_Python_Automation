...
DROP PROCEDURE IF EXISTS [dbo].[spiuBCDHotelMaster]
GO

/****** Object:  StoredProcedure [dbo].[spiuBCDHotelMaster]    Script Date: 2/7/2020 1:49:25 PM ******/
SET ANSI_NULLS ON
GO
...
V2			SH					02-07-2020				Added column LanyonID (DN-1651)
 ================================================================================================================  
*/ 
...
--While going to integrate with Denodo the following code will address the issue that may occur due to NULL value in the column UPDATEDT of existing data. 		
		OR h1.UpdateDt iS NULL
